...
<div class="container">
    <header>
     ...
     <div class="profile-section"> 
        ...
        <br><br><p>Then</p><br><br>
          <button onclick="window.open('https://robertsspaceindustries.com/en/comm-link/transmission/21285-Pirate-Week-2026#8b8b3101', '_blank', 'noopener, noreferrer')" class="paste-link">
            <div class="btn-cells">
                <span></span>
                <span></span>
                <span></span>
    ...
    <script>
        ...
        const codeText = "7-AQ42-0829-4567-15-RDFE4587-324-L6";        
        function copyCode() {
